/**
 * Test case format:
 * [signature, data, shouldFail?, expectedResult?, unmarshallOptions?]
 *
 * - signature: D-Bus type signature
 * - data: Input data to marshall
 * - shouldFail: If false, test is expected to have different output than input
 * - expectedResult: Expected result after unmarshalling (if different from input)
 * - unmarshallOptions: Options to pass to unmarshall
 */
export type TestCase = [
  ...
  unmarshallOptions?: { ReturnLongjs?: boolean },
]
